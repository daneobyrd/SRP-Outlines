...
namespace Shaders.CustomColorBufferOutlines.Editor
{
        ...
        internal class RenderObjectsPassFeatureEditor : PropertyDrawer
        {
            internal class Styles
            {
                ...
                public static GUIContent renderHeader =
                    new GUIContent("Overrides", "Different parts of the rendering that you can choose to override.");
                ...
                public static GUIContent shaderPassFilter =
                    new GUIContent("LightMode Tags", "Controls which shader passes to render by filtering by LightMode tag.");
                ...
                //Depth Settings
                public static GUIContent overrideDepth = new GUIContent("Depth",
                ...
                public static GUIContent cameraFOV =
                    new GUIContent("Field Of View", "The camera's view angle measured in degrees along vertical axis.");

                public static GUIContent positionOffset =
                    new GUIContent("Position Offset", "Position offset to apply to the original camera's position.");
