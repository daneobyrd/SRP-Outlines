...
float3 xyz2rgb(float3 c) {
    ...
    float3 r;
    r.x = (v.r > 0.0031308) ? ((1.055 * pow(abs(v.r), (1.0 / 2.4))) - 0.055) : 12.92 * v.r;
    r.y = (v.g > 0.0031308) ? ((1.055 * pow(abs(v.g), (1.0 / 2.4))) - 0.055) : 12.92 * v.g;
    r.z = (v.b > 0.0031308) ? ((1.055 * pow(abs(v.b), (1.0 / 2.4))) - 0.055) : 12.92 * v.b;
    return r;
}
