...
namespace Plugins.ScriptableRenderPass
{
    ...
    /// <inheritdoc />
    public class FullscreenEdgeDetection : UnityEngine.Rendering.Universal.ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            cmd.DrawMesh(RenderingUtils.fullscreenMesh, Matrix4x4.identity, _material, default, _passIndex);
